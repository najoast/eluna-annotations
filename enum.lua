...
enum.PlayerEvents = readOnly {
    ...
    PLAYER_EVENT_ON_CAN_USE_ITEM            =     31,       -- (event, player, itemEntry) - Can return InventoryResult value = enum
...
enum.GameObjectEvents = readOnly {
...
---@alias MapEvents InstanceEvents

---@class TeamId
enum.TeamId = readOnly {
    TEAM_ALLIANCE = 0,
    TEAM_HORDE    = 1,
    TEAM_NEUTRAL  = 2,
}
